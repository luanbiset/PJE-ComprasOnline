...
INSERT INTO pje_adm.TAB_ITEM_PEDIDO (IDT_PEDIDO,IDT_PRODUTO,QTD_ITEM,DES_UNI_MEDIDA,VAL_TOTAL_ITEM,VAL_DESCONTO,DAT_CRIACAO,DAT_ATUALIZACAO,IDT_USR_CRIACAO,IDT_USR_ALTERACAO) VALUES
	 (1,1,1,'Unidade',4200.99,0.00,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1,NULL)
	 ON DUPLICATE KEY UPDATE QTD_ITEM = VALUES (QTD_ITEM), DES_UNI_MEDIDA = VALUES (DES_UNI_MEDIDA), VAL_TOTAL_ITEM = VALUES(VAL_TOTAL_ITEM), VAL_DESCONTO = VALUES (VAL_DESCONTO), DAT_ATUALIZACAO = CURRENT_TIMESTAMP, IDT_USR_ALTERACAO = 1;
	 COMMIT;