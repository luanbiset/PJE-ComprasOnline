...
(
    SELECT IF(
        ...
        'CREATE TABLE TAB_ITEM_PEDIDO (
			...
			VAL_TOTAL_ITEM DECIMAL(12,2) NOT NULL									 COMMENT ''[NOT_SECURITY_APPLY] - Valor total do item no pedido.'',
			VAL_DESCONTO DECIMAL(12,2) NOT NULL									 	 COMMENT ''[NOT_SECURITY_APPLY] - Valor de desconto por item.'',
			VAL_FINAL_ITEM DECIMAL(12,2) NOT NULL									 COMMENT ''[NOT_SECURITY_APPLY] - Valor final do item após aplicado o desconto.'',
