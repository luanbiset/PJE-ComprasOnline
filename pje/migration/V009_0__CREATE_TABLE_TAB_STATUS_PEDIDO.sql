...
(
    SELECT IF(
        ...
        'CREATE TABLE TAB_STATUS_PEDIDO (
			...
			DES_STATUS_PEDIDO VARCHAR(50)											 COMMENT ''[NOT_SECURITY_APPLY] - Descrição do status do pedido.'',
            ...
            CONSTRAINT PED_PK PRIMARY KEY (IDT_STATUS_PEDIDO),
			CONSTRAINT PED_UK01 UNIQUE (DES_STATUS_PEDIDO)
...
INSERT INTO pje_adm.TAB_STATUS_PEDIDO (DES_STATUS_PEDIDO,DAT_CRIACAO,DAT_ATUALIZACAO,USR_CRIACAO,USR_ALTERACAO) VALUES
	 ('Pendente','2026-06-17 01:53:44','2026-06-17 01:53:44',1,NULL),
	 ('Enviado','2026-06-17 01:53:44','2026-06-17 01:53:44',1,NULL),
	 ('Concluído','2026-06-17 01:53:44','2026-06-17 01:53:44',1,NULL) ON DUPLICATE KEY UPDATE DES_STATUS_PEDIDO = VALUES( DES_STATUS_PEDIDO);
	 COMMIT;
