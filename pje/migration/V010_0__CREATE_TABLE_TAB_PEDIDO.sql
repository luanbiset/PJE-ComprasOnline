...
(
    SELECT IF(
		...
		'CREATE INDEX PED_IDX01 ON TAB_PEDIDO(DAT_PEDIDO,IDT_STATUS_PEDIDO,VAL_TOTAL_PEDIDO)'
			 )
);
...
INSERT INTO pje_adm.TAB_PEDIDO (IDT_CLIENTE,IDT_STATUS_PEDIDO,NUM_PEDIDO,VAL_TOTAL_PEDIDO,DES_OBS,DAT_PEDIDO,DAT_ATUALIZACAO,IDT_USR_CRIACAO,IDT_USR_ALTERACAO) VALUES
	 (1,1,3,4200.99,NULL,'2026-06-17 01:54:17','2026-06-17 01:54:17',1,NULL) ON DUPLICATE KEY UPDATE VAL_TOTAL_PEDIDO = VALUES (VAL_TOTAL_PEDIDO), IDT_STATUS_PEDIDO = VALUES(IDT_STATUS_PEDIDO), DES_OBS = VALUES (DES_OBS), DAT_ATUALIZACAO = CURRENT_TIMESTAMP, IDT_USR_ALTERACAO = 1;
	 COMMIT;
