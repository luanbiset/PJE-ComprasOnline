...
SET @sql := (
    SELECT IF(
        ...
        'CREATE TABLE TAB_CLIENTE (
            ...
            IDT_IDT_USR_CRIACAO BIGINT NOT NULL 								 COMMENT ''[NOT_SECURITY_APPLY] - Usuário responsável pela criação do registro.'',
...
INSERT INTO pje_adm.TAB_CLIENTE (NUM_CPF,NAM_CLIENTE,DAT_NASCIMENTO,FLG_ATIVO,DAT_CRIACAO,DAT_ATUALIZACAO,IDT_IDT_USR_CRIACAO,IDT_IDT_USR_ALTERACAO) 
