...
SET @sql := (
    SELECT IF(
        ...
        'CREATE TABLE TAB_CLIENTE (
            ...
            CONSTRAINT CID_UK01 UNIQUE (NUM_CPF)
...
INSERT INTO pje_adm.TAB_CLIENTE (NUM_CPF,NAM_CLIENTE,DAT_NASCIMENTO,FLG_ATIVO,DAT_CRIACAO,DAT_ATUALIZACAO,USR_CRIACAO,USR_ALTERACAO) VALUES ('01212332122','Luan Biset','1992-06-18',1,'2026-06-17 01:49:35','2026-06-17 01:49:35',1,NULL);
