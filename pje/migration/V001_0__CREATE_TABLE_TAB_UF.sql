...
SET @sql := (
    SELECT IF(
        ...
        'CREATE TABLE TAB_UF (
            ...
            DES_UF VARCHAR(100) NOT NULL 							 COMMENT ''[NOT_SECURITY_APPLY] - Nome da UF.'',
            ...
            CONSTRAINT UF_UK02 UNIQUE (DES_UF),
...
insert into TAB_UF (COD_UF,DES_UF,SG_UF,DAT_CRIACAO,DAT_ATUALIZACAO,USR_CRIACAO) values (5,'BAHIA','BA',current_timestamp,current_timestamp,1);