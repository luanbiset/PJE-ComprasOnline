...
INSERT INTO pje_adm.TAB_TELEFONE_CLIENTE (IDT_CLIENTE,COD_DDD,NUM_TELEFONE,TP_TELEFONE,FLG_PRINCIPAL,DAT_CRIACAO,DAT_ATUALIZACAO,IDT_USR_CRIACAO,IDT_USR_ALTERACAO) VALUES
	 (1,71,'992070072',1,1,'2026-06-17 01:51:46','2026-06-17 01:51:46',1,NULL)
	 ON DUPLICATE KEY UPDATE COD_DDD = VALUES(COD_DDD), NUM_TELEFONE = VALUES(NUM_TELEFONE), TP_TELEFONE = VALUES(TP_TELEFONE), FLG_PRINCIPAL = VALUES(FLG_PRINCIPAL), DAT_ATUALIZACAO = CURRENT_TIMESTAMP, IDT_USR_ALTERACAO = 1;
	 COMMIT;
